# FastTouch 0.1.0 [ALPHA] — Native touchscreen input for Java
...
1. 📦 **[fasttouch-0.1.0.jar](https://github.com/andrestubbe/FastTouch/releases/download/0.1.0/fasttouch-0.1.0.jar)** (The Core Library)
...
- [FastTouch](https://github.com/andrestubbe/FastTouch) — Native Windows RawInput API for Java
